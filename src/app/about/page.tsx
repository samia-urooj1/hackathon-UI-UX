    ...
    return(
        <div>
            <div className="flex grid grid-cols-1 xl:grid-cols-2">
                <div className="h-[380px] w-[400px] sm:w-[580px] bg-sky-800 m-2 mt-10 sm:m-8 lg:m-14 sm:ml-[20px] md:ml-[60px] lg:ml-[240px]">
                ...
                <Link href="/product"><button className="mt-20 mb-2 bg-sky-700 h-12 w-[200px] ml-8 text-white">View Collection</button></Link>
                </div>

                <div className="mt-14">
              <img className="h-[380px] w-[400px] sm:w-[580px] ml-2 sm:ml-[20px] md:ml-[60px] lg:ml-[240px]" src="/image/whitechair3.jpg"></img>
                </div>
            </div>


            <div>
                <h1 className="text-center text-2xl xl:text-3xl font-bold mt-14">What Makes Our Brand Different</h1>
             <div className="flex grid lg:grid-cols-3 sm:grid-cols-2 xl:grid-cols-4 ml-[40px] sm:ml-2 md:mx-[40px] xl:mx-[140px] mt-14">
            ...
            <div className=" mt-[140px] mb-8">
                <h1 className=" font-bold ml-[40px] lg:ml-[100px] xl:ml-[300px] text-3xl ">Our Popular Products</h1>
                <div className="flex gap-6 justify-items-center grid grid-cols-2 md:grid-cols-3 ml-[40px] lg:ml-[100px] xl:ml-[300px] mt-12">
                <div>
